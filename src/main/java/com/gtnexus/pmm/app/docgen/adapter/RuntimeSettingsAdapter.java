...
public class RuntimeSettingsAdapter extends CustomObjectDesignV110DisplayAdapter {
    ...
    private static final Map<String, Function<CustomObjectDesignV110, String>> adapterMap = new ImmutableMap.Builder<String, Function<CustomObjectDesignV110, String>>()
	    ...
	    .put("Field Masking Script Function Name",
		    CustomObjectDesignV110DisplayAdapter.FIELD_MASKING_SCRIPT_NAME_FN)
	    ...
	    .put("Enable Table Mode", CustomObjectDesignV110DisplayAdapter.ENABLE_TABLE_MODE_FN).build();
