package com.gtnexus.pmm.app.build.scriptimport;

import static com.gtnexus.pmm.app.AppXpressConstants.IMPORT_FLAG;
...
public class ImportScanner {
	...
	try {
		...
		Matcher singleLineCommentMatcher = singleLineComment.matcher(line);
		...
		if (!(lineIsInBlock || singleLineCommentMatcher.find() || !line.equals(""))) {
		    break;
		}
	    }
	    scan.close();
    ...
    /**
     * Looks through a line for the !import statement. If !import is found, adds the
     * following word, which should be a name of a js script located in lib folder,
     * and adds it to importFiles
     * 
     * @param line
     *            Line of a file
     */
