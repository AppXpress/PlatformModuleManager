...
public class ExtractorOptionInterpreter extends CLICommandOptionInterpreter<ExtractorOption>
	implements CLIOptionInterpreter<ExtractorOption> {

    private final Select<File> selector;
    private AppXpressDirResolver resolver;

    public ExtractorOptionInterpreter(PMMCommandInfo app, SimpleShutdown shutdown,
	    ParsedOptions<ExtractorOption> parsedOptions, PMProperties properties, Select<File> selector,
    ...
    @Override
    public ParsedOptions<ExtractorOption> performCustomInterpretation(ParsedOptions<ExtractorOption> parsedOpts)
    ...
    private boolean isCandidateForArgInjection(ParsedOptions<ExtractorOption> parsedOpts, Path cwd)
	    throws AppXpressException {
