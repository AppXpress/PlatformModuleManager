...
/**
 * Place holder, while we wait to write decorators for our value objs.
 * Immutable Maps do not allow for null values. Since we are using this
 * for display purposes only, we can say that a null value is approx the
 * same as the empty string.
 * 
 * This is the worst class name ever.
 *
 * @param <X> The Key type for this map.
 */
