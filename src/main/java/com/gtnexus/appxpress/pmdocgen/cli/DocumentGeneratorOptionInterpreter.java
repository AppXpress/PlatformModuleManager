...
public class DocumentGeneratorOptionInterpreter extends CLICommandOptionInterpreter<CLICommandOption>
	...
	public DocumentGeneratorOptionInterpreter(
			PMMCommandInfo app, 
			SimpleShutdown shutdown,
			ParsedOptions<CLICommandOption> parsedOptions, 
	...
	private void doSelect(ParsedOptions<CLICommandOption> parsedOpts, Path cwd)
			throws AppXpressException {
