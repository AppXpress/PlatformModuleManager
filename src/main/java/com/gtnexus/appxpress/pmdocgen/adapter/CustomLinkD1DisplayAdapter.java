...
public class CustomLinkD1DisplayAdapter extends DisplayAdapter<CustomLinkD1>{
	...
	public static final Function<CustomLinkD1, String> LINK_ID_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
	...
	public static final Function<CustomLinkD1, String> NAME_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
		public String applyToNonNull(CustomLinkD1 cl) {
			return cl.getName();
		}
	...
	public static final Function<CustomLinkD1, String> STATUS_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
		public String applyToNonNull(CustomLinkD1 cl) {
			return cl.getStatus();
		}
	...
	public static final Function<CustomLinkD1, String> LOCALIZATION_KEY_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
		public String applyToNonNull(CustomLinkD1 cl) {
	...
	public static final Function<CustomLinkD1, String> LINK_TYPE_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
		public String applyToNonNull(CustomLinkD1 cl) {
	...
	public static final Function<CustomLinkD1, String> DISPLAY_LOCATION_FN = new PrimitiveDisplayFunction<CustomLinkD1>() {
		@Override
		public String applyToNonNull(CustomLinkD1 cl) {
