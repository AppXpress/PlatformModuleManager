...
import com.gtnexus.appxpress.platform.module.model.design.EventField;
...
public class EventsDisplayAdapter extends DisplayAdapter<EventField>{
	...
	private final static Map<String, Function<EventField, String>> adapterMap =
			new ImmutableMap.Builder<String, Function<EventField, String>>()
			.put("Field Name", FIELD_NAME_FN)
			.put("Description", DESCRIPTION_FN)
			.put("Event Type", EVENT_TYPE_FN)
			.put("Function Name", FUNCTION_NAME_FN)
			.put("Run Order", FIELD_POSITION_FN)
			.build();
