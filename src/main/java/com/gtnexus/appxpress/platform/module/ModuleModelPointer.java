...
public class ModuleModelPointer {
    ...
    public static ModuleModelPointer make(ModulePointer root, File platformModuleXml, File[] customActions,
	    File[] customLinks, File[] typeExtensions, File[] templates, File[] designs) {
    ...
    public static ModuleModelPointer make(ModulePointer root, File platformModuleXml, List<File> customActions,
	    List<File> customLinks, List<File> typeExtensions, List<File> templates, List<File> designs) {
	return new ModuleModelPointer(root, platformModuleXml, customActions, customLinks, typeExtensions, templates,
		designs);
    }

    private ModuleModelPointer(ModulePointer root, File platformModuleXml, List<File> customActions,
	    List<File> customLinks, List<File> typeExtensions, List<File> templates, List<File> designs) {
	this.root = root;
