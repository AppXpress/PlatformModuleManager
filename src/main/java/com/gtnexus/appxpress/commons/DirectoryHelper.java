...
public class DirectoryHelper {
    ...
    /**
     * @throws AppXpressException if the AppXpress directory does not exist
     ...
     * @throws AppXpressException if the properties file does not exist and a new one cannot be created.
     */
