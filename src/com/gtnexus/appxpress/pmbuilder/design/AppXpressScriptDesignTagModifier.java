...
public class AppXpressScriptDesignTagModifier implements
	...
	AppXpressScriptDesignTagModifier(Document xml, File customObject,
			final String fileExtension, final String mimeTypeValue) {
		this.xml = xml;
