...
import com.gtnexus.pmm.app.platform.module.model.design.LinkField;
...
public class EmbeddedFieldsDisplayAdapter extends DisplayAdapter<LinkField> {
    ...
    private final static Map<String, Function<LinkField, String>> adapterMap = new ImmutableMap.Builder<String, Function<LinkField, String>>()
	    .put("Field Name", NAME_FN).put("Field Position", POSITION_FN).put("Design", DESIGN_FN)
	    .put("Render on UI", RENDER_ON_UI_FN).put("Is Collection?", IS_COLLECTION_FN).build();
